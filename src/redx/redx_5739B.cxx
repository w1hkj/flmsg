...
void cb_redx_5739B_new()
{
	...
	def_redx_5739B_filename.append("new").append(FREDX5739B_EXT);
...
void cb_redx_5739B_wrap_export()
{
	...
	if (base_redx_5739B_filename == string("new").append(FREDX5739B_EXT) ||
		base_redx_5739B_filename == string("default").append(FREDX5739B_EXT) )
...
void cb_redx_5739B_load_template()
{
	...
	const char *p = FSEL::select(
			"Open template file",
			string("Template file\t*").append(TREDX5739B_EXT).c_str(),
...
void cb_redx_5739B_open()
{
	const char *p = FSEL::select(
			_("Open data file"),
			string("ICS-redx_5739B\t*").append(FREDX5739B_EXT).c_str(),
			def_redx_5739B_filename.c_str());
	if (!p) return;
