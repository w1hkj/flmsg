...
/** \mainpage FLMSG Sourcecode Interactive Doxygen Documentation : 000GIT_REVISION000
 <div align="center"><img src="fldigi-psk.png" ></div>

 \section intro Introduction

  Welcome to the FLMSG Interactive Doxygen Sourcecode Documentation!
  Here you'll find information useful for developing and debugging FLMSG. 
  
  FLMSG - File transfers over radio using the Amateur Multicast Protocol v2.0


  <BR>
  \section download To Download FLMSG :
  <UL>
  <LI> To pull latest source with developer access: <B> git clone ssh://<YOUR-LOGIN>\@git.code.sf.net/p/fldigi/flmsg fldigi-flmsg</B></LI>
  <LI> To pull latest source with developer access behind proxy/firewall: <B> git clone https://<YOUR-LOGIN>\@git.code.sf.net/p/fldigi/flmsg fldigi-flmsg</B></LI>
  <LI> To pull latest source with no account, read-only: <B> git clone git://git.code.sf.net/p/fldigi/flmsg fldigi-flmsg</B></LI>
  </UL>
  ...
  <OL>
  <LI>Download the FLMSG sourcecode as described above</LI>
