// hand built - based on same file found in fldigi

#ifndef CONFIG_H_
#define CONFIG_H_

/* Name of package */
#define PACKAGE "flics"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "w1hkj AT w1hkj DOT com"

#define PACKAGE_NAME "flics"
#define PACKAGE_STRING "flics"
#define PACKAGE_VERSION "0.1.11"
#define PACKAGE_TARNAME "flics"
...
/* Defined if snprintf returns -1 when out of buffer space */
...
/* sndfile version */
#define SNDFILE_BUILD_VERSION "1.0.18"
