...
#define mnu_rtf (menu_+8)
#define mnu_text (menu_+9)
#define mnu_qimport (menu_+12)
#define mnu_qexport (menu_+13)
#define mnuWrapImport (menu_+16)
#define mnuWrapExport (menu_+17)
#define mnuAutoSend (menu_+18)
#define mnuExit (menu_+20)
#define mnu_load_template (menu_+23)
#define mnu_save_template (menu_+24)
#define mnu_save_as_template (menu_+25)
#define mnuConfig (menu_+27)
#define mnuOptions (menu_+30)
#define mnuOnLineHelp (menu_+31)
#define mnuAbout (menu_+32)
