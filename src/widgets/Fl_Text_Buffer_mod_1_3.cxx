//
// "$Id: Fl_Text_Buffer_mod.cxx 8040 2010-12-15 17:38:39Z manolo $"
//
...
static void def_transcoding_warning_action(Fl_Text_Buffer_mod *text)
{
 ...
 */
Fl_Text_Buffer_mod::Fl_Text_Buffer_mod(int requestedSize, int preferredGapSize)
{
  mLength = 0;
...
/*
 ...
 single buffer.
 */
char *Fl_Text_Buffer_mod::text() const {
 ...
 */
char *Fl_Text_Buffer_mod::text_range(int start, int end) const {
 ...
 */
char Fl_Text_Buffer_mod::byte_at(int pos) const {
  if (pos < 0 || pos >= mLength)
    return '\0';
  const char *src = address(pos);
  return *src;
...
/*
 ...
 Pos must be at a character boundary.
*/
void Fl_Text_Buffer_mod::insert(int pos, const char *text)
{
  IS_UTF8_ALIGNED2(this, (pos))
...
*/
void Fl_Text_Buffer_mod::replace(int start, int end, const char *text)
{
  // Range check...
  if (!text)
    return;
...
void Fl_Text_Buffer_mod::select(int start, int end)
{
  ...
  Fl_Text_Selection_mod oldSelection = mPrimary;
 ...
 */
void Fl_Text_Buffer_mod::replace_selection(const char *text)
{
...
{
  Fl_Text_Selection_mod oldSelection = mSecondary;
 ...
 */
void Fl_Text_Buffer_mod::replace_secondary_selection(const char *text)
{
...
{
  Fl_Text_Selection_mod oldSelection = mHighlight;
                                            ...
                                            void *cbArg)
{
  ...
  if (toRemove == -1) {
    Fl::error
    ("Fl_Text_Buffer_mod::remove_modify_callback(): Can't find modify CB to remove");
    return;
  }
...
/*
 Remove a callback.
 */
void Fl_Text_Buffer_mod::remove_predelete_callback(Fl_Text_Predelete_Cb bufPreDeleteCB, void *cbArg)
{
  int i, toRemove = -1;
  /* find the matching callback to remove */
  ...
  if (toRemove == -1) {
    Fl::error
    ("Fl_Text_Buffer_mod::remove_predelete_callback(): Can't find pre-delete CB to remove");
    return;
  }
...
/*
 ...
 Pos must be at a character boundary.
 */
char *Fl_Text_Buffer_mod::line_text(int pos) const {
 ...
 */
int Fl_Text_Buffer_mod::line_start(int pos) const 
{
 ...
 */
int Fl_Text_Buffer_mod::line_end(int pos) const {
...
/*
 ...
 NOT UNICODE SAFE.
 */
int Fl_Text_Buffer_mod::word_start(int pos) const {
...
/*
 ...
 NOT UNICODE SAFE.
 */
int Fl_Text_Buffer_mod::word_end(int pos) const {
  // FIXME: character is ucs-4
 ...
 */
int Fl_Text_Buffer_mod::count_displayed_characters(int lineStartPos,
					       int targetPos) const
{
 ...
 */
int Fl_Text_Buffer_mod::count_lines(int startPos, int endPos) const {
...
/*
 ...
 Unicode safe. Start and end must be at a character boundary.
 */
void Fl_Text_Selection_mod::set(int startpos, int endpos)
{
 ...
 */
int Fl_Text_Selection_mod::position(int *startpos, int *endpos) const {
  if (!mSelected)
    return 0;
  *startpos = mStart;
  *endpos = mEnd;
 ...
 */
int Fl_Text_Selection_mod::includes(int pos) const {
...
/*
 ...
 Unicode safe.
 */
void Fl_Text_Buffer_mod::remove_selection_(Fl_Text_Selection_mod * sel)
{
  int start, end;
...
/*
 ...
 Unicode safe.
 */
void Fl_Text_Buffer_mod::replace_selection_(Fl_Text_Selection_mod * sel,
					const char *text)
{
  Fl_Text_Selection_mod oldSelection = *sel;
...
/*
 ...
 Unicode safe.
 */
void Fl_Text_Buffer_mod::call_predelete_callbacks(int pos, int nDeleted) const {
  for (int i = 0; i < mNPredeleteProcs; i++)
...
/*
 ...
 Unicode safe.
 */
void Fl_Text_Buffer_mod::redisplay_selection(Fl_Text_Selection_mod *
					   oldSelection,
...
void Fl_Text_Selection_mod::update(int pos, int nDeleted, int nInserted)
{
 ...
 */
int Fl_Text_Buffer_mod::findchar_forward(int startPos, unsigned searchChar,
				     int *foundPos) const 
{
  if (startPos >= mLength) {
    *foundPos = mLength;
...
/*
 ...
 StartPos must be at a character boundary, searchChar is UCS-4 encoded.
 */
int Fl_Text_Buffer_mod::findchar_backward(int startPos, unsigned int searchChar,
				      int *foundPos) const {
  if (startPos <= 0) {
    *foundPos = 0;
    return 0;
...
const char *Fl_Text_Buffer_mod::file_encoding_warning_message = 
 ...
 */
 int Fl_Text_Buffer_mod::insertfile(const char *file, int pos, int buflen)
{
  FILE *fp;
...
/*
 ...
 Unicode safe.
 */
int Fl_Text_Buffer_mod::outputfile(const char *file,
			       int start, int end,
			       int buflen) {
  FILE *fp;
...
/*
 ...
 Unicode safe.
 */
int Fl_Text_Buffer_mod::prev_char_clipped(int pos) const
{
  if (pos<=0)
    return 0;
 ...
 */
int Fl_Text_Buffer_mod::prev_char(int pos) const
{
  if (pos==0) return -1;
 ...
 */
int Fl_Text_Buffer_mod::next_char(int pos) const
{
  IS_UTF8_ALIGNED2(this, (pos))  
 ...
 */
int Fl_Text_Buffer_mod::next_char_clipped(int pos) const
{
 ...
 */
int Fl_Text_Buffer_mod::utf8_align(int pos) const 
{
  char c = byte_at(pos);
  while ( (c&0xc0) == 0x80) {
    pos--;
...
//
// End of "$Id: Fl_Text_Buffer_mod.cxx 8040 2010-12-15 17:38:39Z manolo $".
//
